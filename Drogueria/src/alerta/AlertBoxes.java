...
public class AlertBoxes {
    ...
    /**
     * @private Metodo que se encarga de invocar una alerta de
     * Precaucion/Atencion
     * @param title El titulo de la alerta
     * @param header El encabezado de la alerta
     * @param content El contenido de la alerta
     ...
     * @param content El contenido de la alerta
     */
    public static  String confirmAlert(String title, String header, String content) {
        String respuesta ="";
    ...
    /**
     * @private Metodo que se encarga de invocar una alerta Personalizada
     * (Pueden modificarla a su gusto si se requiere)
     * @param title El titulo de la alerta
     * @param header El encabezado de la alerta
     * @param content El contenido de la alerta
     */
