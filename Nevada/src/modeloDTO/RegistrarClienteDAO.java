 ...
 * @author user
 */
public interface RegistrarClienteDAO {
     ...
     */
    List<ClienteDTO> obtenerListaUsuario() throws Exception;
    ...
    /**
     * Valida si existe un usuario en el sistema con el número de cédula
     * especificado.
     *
     * @param cc El número de cédula a validar.
     * @return El resultado de la validación. Devuelve un entero que representa
     * la cantidad de usuarios encontrados.
     * @throws Exception Si ocurre algún error durante la operación de
     * validación.
     */
