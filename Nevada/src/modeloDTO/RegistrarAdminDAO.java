...
/**
 * Interfaz que define los métodos para el acceso a datos de registro de
 * administrador.
 */
public interface RegistrarAdminDAO {
     ...
     * @throws Exception Si ocurre algún error durante la inserción.
     */
    void insertarRoles(ArrayList<InsertarRolesDTO> administrador) throws Exception;
     ...
     */
    List<RegistroAdminDTO> obtenerListaUsuario(String usuario) throws Exception;
