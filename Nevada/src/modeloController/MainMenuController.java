...
public class MainMenuController extends BaseController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle bundle) {
        ...
        TreeItem<String> rootItem = new TreeItem<>("root");
            ...
            TreeItem<String> menuItem0 = new TreeItem<>(("Datos"));
            TreeItem<String> menuItem1 = new TreeItem<>(("Configuracion"));

            TreeItem<String> Datos
                    = new TreeItem<>(("Datos Personales"));
             TreeItem<String> Informes
                    = new TreeItem<>(("Informes"));
            

            TreeItem<String> Actividad
                    = new TreeItem<>(("Configuracion"));

            menuItem0.getChildren().add(Datos);
             menuItem0.getChildren().add(Informes);
    ...
    private void validarMenu() throws Exception {
        ...
        if (itemMenu.equals(("Datos Personales"))) {
            cargarVentana("/vistaFXML/DatosPersonalesScene.fxml",
                    "bodyContainer");
    ...
    private void llenarMapaMenu() {
        mapaMenu.put(("Datos Personales"),
                "vistaFXML//ClientesScene");
        mapaMenu.put(("Informes"),
                "vistaFXML//ClientesScene");
        mapaMenu.put(("Ventas"),
